pt_br = {
    ...
    "summary-text": "<p>     Eu sou um fazedor. Entusiasta sobre tudo e definitivamente apaixonado pela vida e pelo " +
        ...
        "                    e uma forte inclinação para alcançar todos. Valores ágeis guiam meu comportamento. Eu gosto" +
        "                    de dizer que eu vivo uma vida ágil e aplico o conceito chave da agilidade na minha própria" +
        "                    vida: reagir as mudanças mais que seguir um plano." +
        "                </p>" +
        "                <p>" +
        "                    Eu escrevi meu primeiro software quando eu tinha 13 anos e isso é basicamente o que tenho " +
        ...
        "                    na igreja, panfleteiro vestido de batman e caixa de loja de roupas. Ultimamente, tenho " +
        "                    expandido meu foco de aprendizagem. Portanto, estou aprendendo francês, astronomia, música," +
        "                    finanças e dança." +
        "                </p>",
    languages: "Idiomas",
    personalSkills: "Habilidades pessoais",
    personalSkillsText: "Aprendizagem rápida; amante do aprender; criatividade; trabalho em equipe; organização; " +
        "                explicador nato; paciente; boa desenvoltura em público; negociador; flexibilidade; integridade;\n" +
        "                    (bom) contador de piadas; muito engraçado; bom humor; vencedor da mega sena.",
    hobbies: "Passatempos",
    hobbiesList: "<li>Cubos mágicos (e variantes);</li>\n" +
        "                    <li>Futebol;</li>\n" +
        "                    <li>Dança;</li>\n" +
        "                    <li>Astronomia;</li>\n" +
